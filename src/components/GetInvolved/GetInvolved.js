	...
	render() {
		...
		if (rules.length) {
			return (
				...
				>
					<div className="section-header" style={{ maxWidth: '66%', marginLeft: 'auto', marginRight: 'auto', marginBottom: 55 }}>
					...
					<div className="section-content" style = {{ maxWidth: '66%', marginLeft: 'auto', marginRight: 'auto' }}>
